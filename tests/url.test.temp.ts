...
//     ...jest.requireActual("../server/packageScore/src/url"), // Preserves other exports from the module
...
//         {
//           name: "README.md",
//           url: "https://api.github.com/repos/test-owner/test-repo/contents/readme",
//         },
//       ];
...
//         content: Buffer.from("README content", "utf-8").toString("base64"),
//       };
...
//         {
//           name: "index.js",
//           url: "https://api.github.com/repos/test-owner/test-repo/contents/index.js",
//         },
//       ];
//       mockedAxios.get.mockResolvedValueOnce({ data: mockRepoContents });
...
//       expect(logger.warn).toHaveBeenCalledWith("No closed issues found", {
//         owner,
//         repo,
//       });
//     });
...
//       });
//       expect(logger.debug).toHaveBeenCalledWith(
//         "Commits and contributors fetched",
//         {
//           owner,
//           repo,
...
//       });
//       expect(logger.error).toHaveBeenCalledWith(
//         "Error fetching commits and contributors",
//         {
//           owner,
//           repo,
...
//       expect(logger.debug).toHaveBeenCalledWith("Fetching all issues", {
//         owner: mockOwner,
//         repo: mockRepo,
//       });
//       expect(logger.debug).toHaveBeenCalledWith("Issues fetched", {
//         owner: mockOwner,
//         repo: mockRepo,
...
//       expect(logger.error).toHaveBeenCalledWith("Error fetching issues", {
//         owner: mockOwner,
//         repo: mockRepo,
//         error: mockError.message,
//       });
